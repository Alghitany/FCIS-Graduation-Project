...
class DeveloperFillProfileScreen extends StatefulWidget {
  ...
  @override
  State<DeveloperFillProfileScreen> createState() =>
      _DeveloperFillProfileScreenState();
}

class _DeveloperFillProfileScreenState
    extends State<DeveloperFillProfileScreen> {
                    ...
                    onPressed: () {
                      if (formState.currentState!.validate()) {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  const DeveloperEnterLocationScreen()),
                        );
                      }
                    },
                  ),
